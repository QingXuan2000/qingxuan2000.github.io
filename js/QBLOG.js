...
const themes = {
  dark: {
    '--primary-color': '#1a365d80',
    '--text-color': 'rgba(220, 230, 245, 1)',
    '--text-shadow-color': 'rgba(26, 54, 93, 0.5)',
    '--text-secondary-color': 'rgba(160, 180, 210, 1)',
    '--bg-color': 'linear-gradient(180deg, rgba(10, 20, 35, 1), rgba(15, 25, 45, 1), rgba(20, 30, 50, 1), rgba(25, 35, 55, 1))',
    '--hero-bg-color': 'rgba(15, 25, 45, 0.8)',
    '--surface-color': 'linear-gradient(rgba(30, 45, 70, 0.3), transparent)',
    '--surface-border-color': 'rgba(26, 54, 93, 0.3)',
    '--border-color': 'rgba(26, 54, 93, 0.2)',
    '--box-shadow-color': 'rgba(0, 0, 0, 0.5)',
    '--divider-color': 'rgba(26, 54, 93, 0.4)',
    '--backdrop-blur': 'blur(1em)',
  },
  light: {
    '--primary-color': '#4169e1b8',
    '--text-color': 'rgba(30, 30, 60, 1)',
    '--text-shadow-color': 'rgba(65, 105, 225, 0.3)',
    '--text-secondary-color': 'rgba(60, 60, 100, 1)',
    '--bg-color': 'linear-gradient(180deg, rgba(240, 245, 255, 1), rgba(230, 235, 250, 1), rgba(220, 225, 245, 1), rgba(210, 215, 240, 1))',
    '--hero-bg-color': 'rgba(230, 235, 250, 0.8)',
    '--surface-color': 'linear-gradient(rgba(255, 255, 255, 0.3), transparent)',
    '--surface-border-color': 'rgba(65, 105, 225, 0.3)',
    '--border-color': 'rgba(65, 105, 225, 0.2)',
    '--box-shadow-color': 'rgba(65, 105, 225, 0.2)',
    '--divider-color': 'rgba(65, 105, 225, 0.3)',
    '--backdrop-blur': 'blur(1em)',
  },
}
